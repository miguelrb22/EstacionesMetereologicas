...
public class Registro {
    ...
    public static void main (String args[])
    {
        ...
        try
        {
            ...
            //En una terminal ejecuto el servidor de registro de nombres, en el directorio donde este el registrar.policy
            ...
            String[] namesR = Naming.list("//" + "localhost:1099" + "/");
    ...
    private static int getEstacionLibre(String[] names){
        ...
        while (encontrado==false) {
            ...
            if(Arrays.asList(names).contains("//localhost:1099/Estacion"+aux)){
